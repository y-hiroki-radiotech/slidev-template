...
<div class="mt-3"></div>
<div class="text-lg">
<h3 class="text-xl mb-4"><mdi-chart-line class="text-green-500" /> 投与量（成人）の比較</h3>

<div class="grid grid-cols-2 gap-6">
<div>
<h4 class="font-semibold mb-2">脳血流シンチ（ECD）</h4>
<div class="text-sm space-y-1">
<div>• 安静・負荷1回: <strong>800 MBq</strong> <span class="text-gray-500">(変更なし)</span></div>
<div>• 安静+負荷: <strong>1100 MBq</strong> <span class="text-gray-500">(変更なし)</span></div>
</div>
</div>

<div>
<h4 class="font-semibold mb-2">心筋シンチ</h4>
<div class="text-sm space-y-1">
<div>• 201Tl-chloride: <strong>120 MBq</strong> <span class="text-gray-500">(維持)</span></div>
<div>• 99mTc-tetrofosmin: <strong>840/1200 MBq</strong> <span class="text-gray-500">(維持)</span></div>
</div>
</div>
</div>

<h3 class="text-lg mb-2 mt-6"><mdi-chart-bar class="text-blue-500" /> PET-CT CTDIvol の比較</h3>

| 撮影範囲 | 2020 (mGy) | 2025 (mGy) | 変化率 |
|------|-------------|-------------|---------|
| 全身（診療） | 6.1 | 5.4 | <span class="text-green-500">-11%</span> |
</div>

<div class="mt-4 p-3 border border-purple-200 rounded-lg">
<div class="flex items-center gap-2">
<mdi-plus-circle class="text-purple-500" />
<span class="font-semibold">新規追加項目</span>
</div>
<div class="mt-1 text-sm">心アミロイドーシス（99mTc-PYP: 840 MBq、99mTc-HMDP: 870 MBq）</div>
</div>
